...
export interface LocaleDefinition {
  ...
  id: LocaleId
  /** Display name in its own language (中文 / English / Português (Brasil)). */
  label: string
}
 ...
 * `zh`/`en`/`pt` dictionaries carry identical key sets, so neither direction
 * can leave a key unresolved; the residual case points at English rather than
