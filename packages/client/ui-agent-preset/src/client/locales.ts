...
export const pt: Record<AgentPresetSettingsKey, string> = {
  ...
  description: 'Aplica-se a sessões iniciadas a partir de agora. Sessões em execução mantêm o preset com o qual começaram.',
  ...
  headerHint: 'O preset de agente desta sessão, fixado quando ela iniciou',
  nav: 'Presets de agente',
  sectionIntro: 'Um preset é a composição de plugins que o agente de uma sessão executa — suas ferramentas, prompt e capacidades. Duplique um existente e personalize-o, ou deixe o agente criar um para você no Modo criador.',
  builtIn: 'Integrado',
  setDefault: 'Definir como padrão',
  view: 'Visualizar',
  presetStandardName: 'Modo padrão',
  presetStandardDescription: 'Agente de codificação completo com edição de arquivos, terminal, pesquisa de arquivos e web, habilidades, planejamento, objetivos, subagentes e fluxos de trabalho.',
  presetCodeName: 'Modo PTC',
  presetCodeDescription: 'Todas as capacidades do Modo padrão, com ferramentas expostas pelo SDK do Code Mode para que o modelo combine operações de várias etapas em um único programa TypeScript.',
  ...
  presetCordisDescription: 'Feito para criar presets de agente personalizados, com todas as capacidades do Modo padrão além de inspeção em tempo de execução, experimentos com plugins e orientação para criação de presets.',
  duplicate: 'Duplicar',
  ...
  presetIdPlaceholder: 'my-agent',
  displayName: 'Nome',
  displayNamePlaceholder: 'Exibido no seletor; assume o identificador se vazio',
  inUse: 'Em uso',
  ...
  copyIntro: 'O preset inteiro é copiado nesta máquina. O identificador vira o nome do diretório e não pode ser alterado depois; todo o resto é editado nos próprios arquivos do preset.',
  create: 'Criar',
  creating: 'Criando…',
  creatorDraft: 'Criar um preset personalizado com o Modo criador',
  ...
  idInvalid: 'Use letras minúsculas, dígitos e hifens, começando com uma letra ou dígito.',
