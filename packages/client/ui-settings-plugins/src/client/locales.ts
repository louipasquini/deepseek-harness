...
export const pt: Record<PluginsSettingsLocaleKey, string> = {
  ...
  bashMaxOutputBytesHint: 'A saída além desse limite é gravada em um arquivo temporário em vez de ser perdida.',
  ...
  agentLoopMaxParallelHint: 'Limite superior de chamadas paralelas seguras executadas ao mesmo tempo em uma etapa.',
  webSearchTitle: 'Pesquisa na web',
  webSearchDescription: 'O provedor de pesquisa DeepSeek.',
  webSearchApiKey: 'Chave da API',
  ...
  webSearchApiKeyUnset: 'Nenhuma chave configurada; a pesquisa fica indisponível até que uma seja definida.',
  webSearchBaseUrl: 'Endpoint',
