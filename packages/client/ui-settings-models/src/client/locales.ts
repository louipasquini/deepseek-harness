...
export const pt: { [Key in keyof typeof en]: string } = {
  ...
  deleteDescription: 'Excluir {provider} remove sua configuração. Qualquer credencial usada por ele é gerenciada em outro lugar e será mantida.',
  ...
  keyInput: 'Chave da API',
  keyPlaceholder: 'Digite sua chave de API',
  keyPlaceholderNative: 'Digite uma chave de API ou deixe em branco para usar a autenticação por ambiente',
  ...
  modelsEmpty: 'Nenhum modelo será exibido no seletor. IDs fora do catálogo ainda podem ser enviados diretamente.',
  ...
  customRouteHint: 'Identificador em minúsculas, começando com uma letra, que nomeia este provedor de forma única nas solicitações e como nome de sua credencial.',
  ...
  onboardingDescription: 'Configure o provedor oficial do DeepSeek para começar a criar.',
