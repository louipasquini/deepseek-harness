...
export const pt = {
  ...
  'stats.ttftAverage': 'TTFT média {duration}',
  'stats.tokensPerSecond': '{throughput} tok/s',
  'stats.cacheHit': 'Acerto de cache {percent}%',
  'stats.tokens': 'Entrada {input} tok · Saída {output} tok',
  'settings.enter.title': 'Comportamento da tecla Enter quando ocupado',
  ...
  'access.confirm.description': 'Com Full access, o agente reduz as etapas de confirmação e pode executar mais ações diretamente, incluindo operações sensíveis, alterações de arquivos ou comandos externos. Use somente quando confiar na tarefa atual.',
  ...
  'hero.headline': 'Explorando o desconhecido',
  ...
  'details.empty': 'Clique em uma linha de ferramenta no fluxo de mensagens para ver seus detalhes',
  ...
  'message.compaction.completed': 'Compactadas {items} entradas de histórico (~{tokens} tokens)',
  ...
  'message.retry.active': 'Tentando novamente a solicitação do modelo',
  'message.retry.cancelled': 'Nova tentativa de solicitação do modelo cancelada',
  'message.retry.started': 'Solicitação do modelo tentada novamente',
  'message.retry.scheduled': 'Aguardando para tentar novamente a solicitação do modelo',
  'message.retry.status': '{label} ({retry}/{maximum}) · {seconds}s',
